...
import mobileMenuOpen from './images/MENU_MOBILE.svg';
import mobileMenuClose from './images/MENU_MOBILE_CLOSE.svg';
      ...
      <header className="banner">
        <div className="header">
          ...
          <nav className="header__navigation">
            <button className={`header__navigation__menu ${isMenuVisible ? 'open' : ''}`} onClick={handleMenuClick}></button>
            <a className={`header__navigation__home ${isMenuVisible ? 'visible' : ''}`} href="#">Home</a>
            <a className={`header__navigation__products ${isMenuVisible ? 'visible' : ''}`} href="#">Products</a>
            <a className={`header__navigation__basket ${isMenuVisible ? 'visible' : ''}`} href="#">
              <svg className="header__navigation__basket-icon" width="24" height="21" viewBox="0 0 24 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                <defs>
